...
public class SecurityConfigurations {
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
		return httpSecurity
				.csrf(csrf -> csrf.disable()).sessionManagement(session -> session.sessionCreationPolicy(
				...
				.authorizeHttpRequests(authorize -> authorize
						...
						.requestMatchers(HttpMethod.GET, "/billing-addresses/authuser").hasAnyRole("ADM", "STAFF", "TENANT")
						.requestMatchers(HttpMethod.PATCH, "/billing-addresses/{id}").hasAnyRole("ADM", "STAFF", "TENANT")
						...
						.requestMatchers(HttpMethod.PATCH, "/staffs/{id}").hasAnyRole("ADM", "STAFF")
